...
internal class AlarmNotificationRepository(
    ...
    suspend fun getAlarmNotification(intentId: Int): AlarmNotification {
        ...
        return AlarmNotification(
            ...
            isVibrate = alarmNotification.alarmNotificationEntity.isVibrate,
            nameAlarm = alarmNotification.alarmNotificationEntity.nameAlarm,
            voicePath = alarmNotification.alarmNotificationEntity.voicePath
        )
    }
    ...
    suspend fun deactivateSingleAlarmNotification(intentId: Int) {
        ...
        updateAlarmNotification(
            ...
            false,
            isVibrate = alarmNotification.alarmNotificationEntity.isVibrate,
            nameInfo = alarmNotification.alarmNotificationEntity.nameAlarm,
            voicePath = alarmNotification.alarmNotificationEntity.voicePath
        )
    }
