package com.merryblue.myvoicealarm.ui.addalarm.custom_visualizer
...
import com.merryblue.myvoicealarm.common.extenstion.setBackground
...
class Visualizer(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val barsColor = Color.rgb(33,19,13)
    ...
    init {
        setBackground(R.drawable.bg_visualizer) // showing bounding box of the view
    }
